...
echo "CUDA_VISIBLE_DEVICES=${gpu_id} python simpler_env/main_inference.py --policy-model ${policy_model} --action-ensemble-temp ${action_ensemble_temp} --logging-dir ${logging_dir} --server-ip ${server_ip} \
